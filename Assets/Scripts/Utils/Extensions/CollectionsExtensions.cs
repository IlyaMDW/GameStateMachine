...
namespace Utils.Extensions
{
    public static class CollectionsExtensions
    {
        ...
        public static int RandomIndexWithProbabilities(this List<float> probabilities, Func<int, bool> skipPredicate = null)
        {
            float total = 0;
            ...
            for (var i = 0; i < probabilities.Count; i++)
            {
                ...
                if (skipPredicate != null && skipPredicate.Invoke(i)) continue;
                total += elem;
            }
